...
namespace Testproject1
{
    ...
    public class UnitTest1
    {
        ...
        public void ServiceInvoiceAddcost_negative_throws()
        {
            ...
            ServiceInvoice1.AddCost(ServiceInvoice.CostType.Labour, -1);
        }
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        ...
        {
            ServiceInvoice ServiceInvoice1 = new ServiceInvoice(0.1m, 0.1m);
            ServiceInvoice1.AddCost(ServiceInvoice.CostType.Labour, 0);
        }
        [TestMethod]
        ...
        {
            ServiceInvoice ServiceInvoice1 = new ServiceInvoice(0.1m, 0.1m);    
            ServiceInvoice1.AddCost((ServiceInvoice.CostType) 5, 1); //interesting
        }
